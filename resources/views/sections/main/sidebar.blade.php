<!-- Sidebar = sb -->
<!-- Dropdown = dd -->
<section class="sidebar-section flex">
    <div class="sidebar-container">
        <div class="mobile-nav-button">
            <button class="buttonMobile" aria-controls="primary-navigation" aria-expanded="false">
                <svg stroke="#0984e3" class="brger" fill="none" viewBox="-10 -10 120 120" width="70">
        ...
        <div class="sidebar-content flex dir-col">
            ...
            <div class="sb-funcs flex dir-col">
                ...
                <div class="sb-item flex" id="first-bar">
                    <div class="dd-name flex">
                        <div class="bar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sb-dd-icon" id="analytics-icon">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
                            </svg>
                        </div>
                        <p class="bar-name">Analitycs</p>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sb-dd-arrow">
                ...
                <div class="sb-item flex" id="first-bar">
                    <div class="dd-name flex">
                        <div class="bar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256" class="sb-dd-icon" id="car-icon">
                        ...
                        <p class="bar-name">Vehicle management</p>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sb-dd-arrow">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                    </svg>
            ...
            <div class="sb-options">
                ...
                <div class="sb-item flex" id="first-bar">
                    <div class="dd-name flex">
                        <div class="bar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sb-dd-icon" id="support-icon">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                        </div>
                        <p class="bar-name">Support</p>
                    </div>
                </div>
                <!-- TWO -->
                <div class="sb-item flex" id="first-bar">
                    <div class="dd-name flex">
                        <div class="bar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sb-dd-icon" id="settings-icon">
                ...
                <div class="sb-item flex" id="first-bar">
                    <div class="dd-name flex">
                        <div class="bar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sb-dd-icon" id="logout-icon">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                            </svg>
                        </div>
                        <p class="bar-name">Log out</p>
                    </div>
                </div>
            </div>
            <div class="sb-user flex">
                <div class="test-picture"></div>
                <div>
                    <p>Ante Antic</p>
