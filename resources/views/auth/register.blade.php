...
@section('title', 'Fuelprint — Sign up')

@push('styles')
<link rel="stylesheet" href="{{ asset('css/default.css') }}">
<link rel="stylesheet" href="{{ asset('css/forms/form.css') }}">
<link rel="stylesheet" href="{{ asset('css/forms/form.queries.css') }}">
@endpush
...
<div class="form-container grid grid-2-cols">
    ...
    <div class="form-content register flex dir-col">
        <div class="form-heading">
            <h2 class="heading-secondary" id="form-heading">Create an account</h2>
            <p>Already have an account? <a href="{{route('show.login')}}">Login here</a></p>
        </div>
        <div class="auth-form">
            <form method="POST" action="{{route('register')}}" class="flex dir-col">
                @csrf
                <div class="form-box flex dir-col">
                    <label for="name">Name *</label>
                    <input type="text" class="email-input" name="name" placeholder="" value="{{old('name')}}">
                    @error('name')
                ...
                <div class="form-box flex dir-col">
                    ...
                    <input type="text" class="email-input" name="email-register" placeholder="email.example@" value="{{old('email')}}">
                ...
                <div class="form-box flex dir-col">
                    ...
                    <div class="">
                        <ul class="conditions">
                            <li class="cond-caracters">
                                <p>8 caracters</a>
                            </li>
                            <li class="cond-numbers">
                                <p>At least one number</p>
                            </li>
                            <li class="cond-symbols">
                ...
                <input type="submit" value="Sign up" class="form-btn" id="">
            </form>
        </div>
    </div>
</div>
